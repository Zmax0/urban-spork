...
class AeadCipherTest {
    ...
    void testChaCha8Poly1305() {
        try (com.urbanspork.jni.chacha8poly1305.Cipher cipher = com.urbanspork.jni.chacha8poly1305.Cipher.newInstance(KEY)) {
    ...
    void testXChaCha8Poly1305() {
        try (com.urbanspork.jni.xchacha8poly1305.Cipher cipher = com.urbanspork.jni.xchacha8poly1305.Cipher.newInstance(KEY)) {
    ...
    void testXChaCha20Poly1305() {
        try (com.urbanspork.jni.xchacha20poly1305.Cipher cipher = com.urbanspork.jni.xchacha20poly1305.Cipher.newInstance(KEY)) {
