...
public class Socks5UdpTestClient extends TestClientTemplate {
    ...
    private void launch() throws InterruptedException, ExecutionException, IOException {
        ...
        HandshakeResult<Socks5CommandResponse> result1 = ClientHandshake.noAuth(group, Socks5CommandType.UDP_ASSOCIATE, proxyAddress, dstAddress1).await().get();
        HandshakeResult<Socks5CommandResponse> result2 = ClientHandshake.noAuth(group, Socks5CommandType.UDP_ASSOCIATE, proxyAddress, dstAddress2).await().get();
