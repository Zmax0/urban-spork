...
public class ClientAEADCodec extends ByteToMessageCodec<ByteBuf> {
    ...
    public void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws Exception {
        if (bodyDecoder == null) {
            ...
            in.readBytes(msg);
            ByteBuf encryptedResponseHeaderBuffer = Unpooled.wrappedBuffer(cipher.decrypt(aeadResponseHeaderPayloadEncryptionKey,
                aeadResponseHeaderPayloadEncryptionIV, msg));
            ...
            // not support handling command now -> encryptedResponseHeaderBuffer.get(1)
