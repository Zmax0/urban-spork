...
public class AES_256_GCM implements ShadowsocksCipher {
    ...
    private Cipher encrypter = new BaseAEADCipher(new GCMBlockCipher(new AESEngine()), 32, 128);
    private Cipher decrypter = new BaseAEADCipher(new GCMBlockCipher(new AESEngine()), 32, 128);
