...
public class AES_256_GCM implements ShadowsocksCipher {
    ...
    private final Cipher encrypter = new BaseAEADCipher(new GCMBlockCipher(new AESEngine()), 32, 128);
    private final Cipher decrypter = new BaseAEADCipher(new GCMBlockCipher(new AESEngine()), 32, 128);
